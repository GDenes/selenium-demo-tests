...
public class DriverFactory {
    ...
    public WebDriver createDriver(final BrowsersEnum browser) {
        switch (browser) {
            ...
            case EDGE_HEADLESS:
                return new EdgeHeadlessFactory().getDriver();
            default:
    ...
    public WebDriver createRemoteDriver(final BrowsersEnum browser, String remoteUrl) {
        switch (browser) {
            ...
            case EDGE:
                return new EdgeFactory().getRemoteWebDriver(remoteUrl);
            case EDGE_HEADLESS:
                return new EdgeHeadlessFactory().getRemoteWebDriver(remoteUrl);
            default:
                throw new UnsupportedOperationException("Browser type is not yet supported");
        }
    }
